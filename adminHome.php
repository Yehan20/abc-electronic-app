...
<body>
          ...
          <div class="container">
              ...
              <ul class="navbar-nav flex-row px-3">
                <li class="nav-item me-3">
                    <a class="btn bg-primary text-white" href="#">Home</a>
                  </li>
                <li class="nav-item">
    ...
    <main class="dashboard mb-5 py-5 bg-light">
        <div class="container">
           <h1 class="text-center">Admins dashboard</h1>
           <div class="row mt-3 mb-5">
       
             <div class="col bg-white d-flex flex-column  p-2 align-items-center">
                <h3 class="text-center">Welcome Admin</h3>
                <img src="icons/admin-logo.svg" class="d-block img-fluid  w-50" alt="">
                <div style="max-width:400px;">
                <h3 class="lh-sm lead mb-3 text-center" id="slider-text"></h3>
                </div>
             </div>
           </div>
        </div>
    ...
    <script>
              ...
              var typed_strings =",Hello Admin,Weclome again ,Here you can order mange the  items then you can process the orders and view the profits"
